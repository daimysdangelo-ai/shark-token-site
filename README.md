...
</header>  <!-- Requins animés -->  <img src="https://cdn.pixabay.com/animation/2023/01/18/15/18/15-18-48-185_512.gif" alt="Requin nageant" class="shark" style="top: 10%; animation-delay: 0s;"/>  
...
<img src="https://cdn.pixabay.com/animation/2023/01/18/15/18/15-18-48-185_512.gif" alt="Requin nageant" class="shark" style="top: 25%; animation-delay: 15s;"/>  <main>  <section>  
...
<body>    <h1>⚒️ Minage THE SHARK TOKEN</h1>  
  <p>  
  ...
  </p>  <button id="connectWalletBtn">Connecter Wallet</button>
<button id="startMiningBtn" disabled>Commencer le minage</button>

  <div id="status"></div>    <div class="nft-info">  
  ...
  </div>    <footer>© 2025 THE SHARK TOKEN</footer>    <script>  
...
<body>    <h1>🛒 Boutique & Merch THE SHARK TOKEN</h1>    <p>  
  ...
  </div>    <section style="margin-top: 50px; max-width: 700px; color: #66ffff; text-shadow: 0 0 6px #33ccff; font-size: 1.2em;">  
  ...
  </section>    <footer>© 2025 THE SHARK TOKEN</footer>  </body>  
</html><nav>  
  <ul>  
    <li><a href="index.html">Accueil</a></li>  
    <li><a href="minage.html">Minage</a></li>  
...
<body>    <h1>🔗 Future plateforme d’échange de memecoins</h1>    <p>  
  ...
  </p>    <h2 class="highlight">Fonctionnalités clés prévues :</h2>  
  <ul>  
  ...
  </p>    <footer>© 2025 THE SHARK TOKEN</footer>  </body>  
</html><nav>  
  <ul>  
    <li><a href="index.html">Accueil</a></li>  
    <li><a href="minage.html">Minage</a></li>  
